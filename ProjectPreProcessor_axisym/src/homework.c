...
void geoMeshGenerate() {
    ...
    int ierr;
    int idRect = gmshModelOccAddRectangle(w/100,0.0,0.0,w,h,-1,0.0,&ierr); 
    int rect[] = {2, idRect};
    int idRect1 = gmshModelOccAddRectangle(w/3,h/4,0.0,w,h/2,-1,0.0,&ierr); 
    int rect1[] = {2, idRect1};

    gmshModelOccCut(rect, 2, rect1, 2, NULL, NULL, NULL, NULL, NULL, -1, 1, 1, &ierr);
